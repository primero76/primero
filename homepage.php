...
<body>
    ...
    <div class="row-homepage">
        ...
        <p class="intro">Primero Avionics is proud to be the youngest domestic Pakistani airline to serve all the areas of Pakistan, and thanks to our customers’ response to our offerings, we are also Pakistan's fastest-growing airline. We connect multiple destinations on the map every day, with a fleet of the latest-generation aircraft, and an unrivalled level of service.
            As aviation faces its greatest challenge, we remain committed to ensuring the highest standards of safety and hygiene on board our aircraft at all times. Primero Avionics is one of the few airlines in the world to achieve the prestigious 5-Star COVID-19 Airline Safety Rating by air transport rating organisation, Skytrax. These recognitions provides assurance to passengers across the world that airline health and safety standards are subject to the highest possible standards of professional, independent scrutiny and assessment.
            ...
            Our goal is to make Primero Avionics your airline of choice, offering the flights you want to the destinations you need. It is this which drives our collective mission to achieve ‘Excellence in everything we do’ at all levels across our Primero Avionics family of highly-skilled and committed professionals.
