        ...
        <div class="row"> 
            <nav>
                <ul>
                    ...
                    <li><i class="fa fa-tasks"></i><a onclick="alert('Complete Booking First')"> Manage </a></li>
                    <li><i class="fa fa-address-book"></i><a onclick="alert('Complete Booking First')">> Contact Us</a></li>
...
<div class="success"> 
    ...
    <br> <br>  
       <h1> Flight has been booked successfully </h1>
        <br> <br>
        <h3> Your tracking id has been sent to your email address </h3>
        <br> <br>
