...
<body>
    ...
    <div class="container">
        <div class="btn-box">
            <button id="forgetBtn1"><i class="fa fa-user"></i> Forget Password </button>
            <button id="forgetBtn2"> </button>       
        </div> 
    <form id="form" class="form" method="POST" action="<?php echo $_SERVER["PHP_SELF"];?>">
    <h3> Enter Code to Reset Password </h3>
    <div class="one">
        <div class="two">
            <div class="three" onclick="openDivemail()">
                <label id="emaillbl"> Code </label>
                <input type="text" id="emailinp" name="codeinp">
                <small> * </small>
            </div>
        </div>
    </div>
    ...
    <div class="one">
        <div class="btn-submit" id="submit">
            <button type="submit" id= "crtAcc" onclick="show()"> Confirm </button>
        </div>
    </div> 
