...
function setErrorFor(input, message) {
	if (input==emailInp || input==mobileInp || input==cityInp)
	{
	...
	else if (input==passwordInp || input==cpasswordInp || input==dobInp || input== genderInp)
	{
		var formctrl = input.parentElement;
		var small = formctrl.querySelector('small');
	...
	else if (input==nameFirstInp || input==nameMiddleInp || input==nameLastInp)
	{
		var formctrl = input.parentElement;
		var small = formctrl.querySelector('small');
		formctrl.className = 'five error';
		small.innerText = message;
	}
}
...
function setSuccessFor(input,message) {
	...
	else if (input==nameFirstInp || input==nameMiddleInp || input==nameLastInp)
	{
		var formctrl = input.parentElement;
		var small = formctrl.querySelector('small');
		formctrl.className = 'five success';
		small.innerText = message;
	}
}
